    ...
    $.fn.formset = function(opts) {
        ...
        if ($this.length && showAddButton) {
            ...
            if ($this.prop("tagName") === "TR") {
                ...
                $parent.append('<tr class="' + options.addCssClass + '"><td colspan="' + numCols + '"><a id="add-btn" href="#">' + options.addText + "</a></tr>");
            ...
            addButton.click(function(e) {
                ...
                if (row.is("tr")) {
                    ...
                    row.children(":last").append('<div><a class="' + options.deleteCssClass + '" style="text-align:center" href="#">' + options.deleteText + "</a></div>");
